...
### Baselines
yearoldq = np.where((years>=1942) & (years<=1978))[0]
...
cbar_ax = fig.add_axes([0.312,0.17,0.4,0.03])                
...
plt.savefig(directoryfigure + 'baselines_Bering.png', dpi=300)
